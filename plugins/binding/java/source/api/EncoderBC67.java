...
public class EncoderBC67 {
	...
	public EncoderBC67() { init_(new_()); }
	public EncoderBC67[] ref() { return new EncoderBC67[] { this }; }
	public boolean equalPtr(EncoderBC67 ptr) { return equal_ptr(self, ptr.self); }
	public EncoderBC67 clonePtr() { return new EncoderBC67(clone_ptr(self)); }
	...
	protected EncoderBC67(long self) {
		init_(self);
	}
	public static EncoderBC67 Null() {
		return new EncoderBC67((long)0);
	}
	protected void init_(long self) {
		if(self != 0) cleaner.register(this, new Destructor(self));
		this.self = self;
	}
	protected static long[] self_(EncoderBC67[] ptr) {
