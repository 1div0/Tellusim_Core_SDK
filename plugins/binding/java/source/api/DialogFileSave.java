...
public class DialogFileSave {
	...
	public static class Flags {
		...
		public static final Enum Overwrite = Enum.Overwrite;
	...
	public DialogFileSave() { init_(new_(null, null)); }
	public DialogFileSave(String title) { init_(new_(title, null)); }
	public DialogFileSave(String title, String name) { init_(new_(title, name)); }
	public DialogFileSave(TSString title) { init_(new_1(title.self, null)); }
	public DialogFileSave(TSString title, String name) { init_(new_1(title.self, name)); }
	public DialogFileSave(String title, TSString name) { init_(new_2(title, name.self)); }
	public DialogFileSave(TSString title, TSString name) { init_(new_3(title.self, name.self)); }
	public DialogFileSave[] ref() { return new DialogFileSave[] { this }; }
	public boolean equalPtr(DialogFileSave ptr) { return equal_ptr(self, ptr.self); }
	public DialogFileSave clonePtr() { return new DialogFileSave(clone_ptr(self)); }
	...
	protected DialogFileSave(long self) {
		init_(self);
	}
	public static DialogFileSave Null() {
		return new DialogFileSave((long)0);
	}
	protected void init_(long self) {
		if(self != 0) cleaner.register(this, new Destructor(self));
		this.self = self;
	}
	protected static long[] self_(DialogFileSave[] ptr) {
