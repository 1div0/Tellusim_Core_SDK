...
/*
 */
public class ControlGrid extends Control {
	
	public ControlGrid() { init_(new_()); }
	public ControlGrid(Control[] parent) { init_(new_1(Control.self_(parent))); }
	public ControlGrid(Control[] parent, int columns) { init_(new_2(Control.self_(parent), columns)); }
	public ControlGrid(Control[] parent, int columns, float x) { init_(new_3(Control.self_(parent), columns, x, 0.0f)); }
	public ControlGrid(Control[] parent, int columns, float x, float y) { init_(new_3(Control.self_(parent), columns, x, y)); }
	public ControlGrid[] ref() { return new ControlGrid[] { this }; }
	public ControlGrid(Control base) { init_(cast_control_ptr(base.self)); }
	...
	protected ControlGrid(long self) {
		init_(self);
	}
	public static ControlGrid Null() {
		return new ControlGrid((long)0);
	}
}
