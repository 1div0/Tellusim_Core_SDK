...
fn main() {
	...
	window.run({
		...
		
		{
			...
			tensor_graph.dispatch_with_op_dest_mut_src1_src2_flags(&mut compute, TensorGraphOperation::MatMul, &mut tensor_8, &tensor_7, &tensors[10], &tensors[11], TensorGraphFlags::Transpose);
		}
